...
import { formatDate, getLabelService, createImagesArray, formatToISODate, formatPrice } from "../lib/utils";
                  ...
                  {datasetTents.tents.map((tentItem, index) => {
                    return (
                      <tr key={"user_key" + index} className="text-slate-400 hover:bg-secondary hover:text-white duration-300 cursor-pointer">
                        ...
                        <td className="">{formatPrice(tentItem.price)}</td>
          ...
          <motion.div
            ...
            <div id="form_create_tent" className="w-full h-auto flex flex-col lg:flex-row gap-6 p-6">
              ...
              <div className="flex flex-col justify-start items-start w-full lg:w-[50%]">
                ...
                <div className="flex flex-row justify-start items-start w-full h-auto overflow-hidden my-1  gap-x-6">
                  <div className="flex flex-col justify-start itemst-start gap-x-6 w-full h-auto gap-y-2 sm:gap-y-1">
                    <label htmlFor="additional_people_price" className="font-primary text-secondary text-xs xl:text-lg h-3 sm:h-6">{t("glamping.glamping_qty_people_price")}</label>
                    <input name="additional_people_price" value={selectedTent.additional_people_price} className="w-full h-8 sm:h-10 text-xs sm:text-md font-tertiary px-2 border-b-2 border-secondary focus:outline-none focus:border-b-2 focus:border-b-primary" placeholder={t("glamping.glamping_qty_people_price")} readOnly />
                  </div>

                  <div className="flex flex-col justify-start itemst-start gap-x-6 w-full h-auto gap-y-2 sm:gap-y-1">
                    <label htmlFor="max_additional_people" className="font-primary text-secondary text-xs xl:text-lg h-3 sm:h-6">{t("glamping.glamping_qty_people_aditional")}</label>
                    <input name="max_additional_people" value={selectedTent.max_additional_people} className="w-full h-8 sm:h-10 text-xs sm:text-md font-tertiary px-2 border-b-2 border-secondary focus:outline-none focus:border-b-2 focus:border-b-primary" placeholder={t("glamping.glamping_qty_people_aditional")} readOnly />
                  </div>
                </div>
            ...
            <form id="form_create_tent" className="w-full h-auto flex flex-col lg:flex-row gap-6 p-6" onSubmit={(e) => onSubmitCreation(e)}>
              ...
              <div className="flex flex-col justify-start items-start w-full lg:w-[50%]">
                ...
                <div className="flex flex-row justify-start items-start w-full h-auto overflow-hidden my-1  gap-x-6">
                  <div className="flex flex-col justify-start itemst-start gap-x-6 w-full h-auto gap-y-2 sm:gap-y-1">
                    <label htmlFor="additional_people_price" className="font-primary text-secondary text-xs xl:text-lg h-3 sm:h-6">{t("glamping.glamping_qty_people_price")}</label>
                    <input name="additional_people_price" className="w-full h-8 sm:h-10 text-xs sm:text-md font-tertiary px-2 border-b-2 border-secondary focus:outline-none focus:border-b-2 focus:border-b-primary" placeholder={t("glamping.glamping_qty_people_price")} />

                    <div className="w-full h-6">
                      {errorMessages.additional_people_price && (
                        <motion.p
                          initial="hidden"
                          animate="show"
                          exit="hidden"
                          variants={fadeIn("up", "", 0, 1)}
                          className="h-6 text-[10px] sm:text-xs text-primary font-tertiary">
                          {t(errorMessages.additional_people_price)}
                        </motion.p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-start itemst-start gap-x-6 w-full h-auto gap-y-2 sm:gap-y-1">
                    <label htmlFor="max_additional_people" className="font-primary text-secondary text-xs xl:text-lg h-3 sm:h-6">{t("glamping.glamping_qty_people_aditional")}</label>
                    <input name="max_additional_people" className="w-full h-8 sm:h-10 text-xs sm:text-md font-tertiary px-2 border-b-2 border-secondary focus:outline-none focus:border-b-2 focus:border-b-primary" placeholder={t("glamping.glamping_qty_people_aditional")} />
                    <div className="w-full h-6">
                      {errorMessages.max_additional_people && (
                        <motion.p
                          initial="hidden"
                          animate="show"
                          exit="hidden"
